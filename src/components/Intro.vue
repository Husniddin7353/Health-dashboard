<template>
    <div class="intro d-flex align-items-center justify-content-between">
        <form action="#">
            <input type="text" class="intro-input" placeholder="Search">
            <button class="intro-btn btn">
        ...
        <div class="profile d-flex" v-for="(item, index) in intro" :key="index">
            <div class="notify"> 
                <button class="notify-btn btn" @click="inc()"> {{ counter }}</button>
